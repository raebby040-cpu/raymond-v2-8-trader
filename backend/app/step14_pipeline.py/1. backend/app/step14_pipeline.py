...
This module connects the Step 13 deterministic AI decision engine
to the risk engine and paper-only execution gateway.
...
- Live-enabled paper gateways are rejected.
"""
...
class Step14Result:
    """Complete result of AI decision, risk validation and execution."""
...
class Step14Pipeline:
    ...
    The AI layer can recommend a trade, but it cannot bypass
    the risk engine.
    """
    ...
    def _context_from_mapping(
        ...
        """Convert an API/strategy mapping into Step 13 context."""
    ...
    def evaluate(
        ...
        *,
        ...
        """Run AI decision and fail-closed risk validation."""
    ...
    async def evaluate_and_execute_paper(
        ...
        *,
        ...
        if getattr(
            ...
            raise Step14PipelineError(
                "Step 14 refuses to execute through "
                "a live-enabled gateway."
            )
